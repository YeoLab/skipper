...
if __name__ == '__main__':
    ...
    for f in (indir/'output/reproducible_enriched_windows').glob('*.tsv.gz'):
        ...
        tested_windows_1 = pd.read_csv(indir / 'output/secondary_results/tested_windows'/ f'{rbp}.{rbp}_IP_1.tested_windows.tsv.gz', sep = '\t')
        tested_windows_2 = pd.read_csv(indir / 'output/secondary_results/tested_windows'/ f'{rbp}.{rbp}_IP_2.tested_windows.tsv.gz', sep = '\t')
